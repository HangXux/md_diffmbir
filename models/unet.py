...
class UNet(nn.Module):
    def __init__(self, in_channels=2, out_channels=1, compact=3, residual=False, circular_padding=False, cat=True):
        ...
        self.Maxpool_3 = nn.MaxPool2d(kernel_size=2, stride=3)
        ...
        self.Up5 = up_conv_2(ch_in=1024, ch_out=512)
        self.Up_conv5 = conv_block(ch_in=1024, ch_out=512)

        self.Up4 = up_conv_3(ch_in=512, ch_out=256)
        self.Up_conv4 = conv_block(ch_in=512, ch_out=256)

        self.Up3 = up_conv_3(ch_in=256, ch_out=128)
        self.Up_conv3 = conv_block(ch_in=256, ch_out=128)

        self.Up2 = up_conv_2(ch_in=128, ch_out=64)
...
class up_conv_3(nn.Module):
    def __init__(self, ch_in, ch_out):
        super(up_conv_3, self).__init__()
        self.up = nn.Sequential(
